...
const PageToOpenModalNoReseizable = () => {
  ...
  const handleFooter = () => (
    <div>
      <button type="button" onClick={action('Button 1 Clciked')}>
        Button 1
      </button>
      <button type="button" onClick={action('Button 2 Clciked')}>
        Button 2
      </button>
    </div>
  )
...
storiesOf('Modal', module).add('Open Modal no reseizable', () => (
  <PageToOpenModalNoReseizable />
))
